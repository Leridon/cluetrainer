...
export class AvaViewer {
	...
	drawInner(timestamp?: number) {
		...
		for (var model of this.models) {
			...
			this.gl.uniformMatrix4fv(this.uniforms.uModelMatrix, false, subview as Float32List);
			this.gl.uniformMatrix4fv(this.uniforms.uViewMatrix, false, viewtr as Float32List);
