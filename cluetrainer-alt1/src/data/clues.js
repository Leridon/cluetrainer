...
export var clue_data;
(function (clue_data) {
    clue_data.gielinor_compass = {
        "id": 399,
        "type": "compass",
        "tier": "elite",
        "text": [
    ...
    clue_data.compass = [clue_data.gielinor_compass, clue_data.arc_compass, clue_data.tetracompass];
    clue_data.simple = [
        {
            "id": 0,
            "type": "simple",
    ...
    clue_data.index = ClueIndex.simple(clue_data.all);
    clue_data.spot_index = ClueSpotIndex.simple(clue_data.index);
})(clue_data || (clue_data = {}));
