...
export class SimpleGLOverlay extends Behaviour {
  ...
  private updateOverlays(triggers: RenderFilter[]) {
    ...
    const [keep, remove] = lodash.partition(this.overlays,
      (o: Alt1GLOverlay) => triggers.some(t => FakeLodash.isEqual(t, o.renderFilter)))
    ...
    const new_triggers = triggers.filter(t => !this.overlays.some(o => FakeLodash.isEqual(o.renderFilter, t)))
