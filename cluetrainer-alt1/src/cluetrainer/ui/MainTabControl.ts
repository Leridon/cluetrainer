...
import ClueSolvingBehaviour from "../cluesolving/ClueSolvingBehaviour";
  ...
  switchToTab(tab: MainTabControl.Tab) {
    ...
    switch (tab) {
      case "map":
        ...
        break;
      case "solve":
        this.app.main_behaviour.set(new ClueSolvingBehaviour(this.app, false))
        break;
      case "tetracompass":
        this.app.main_behaviour.set(new ClueSolvingBehaviour(this.app, true))
        break;
      case "create":
