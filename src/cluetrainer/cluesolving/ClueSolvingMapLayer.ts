...
import {ScanEditLayer} from "../ui/theorycrafting/scanedit/ScanEditor";
...
export class ClueSolvingMapLayer extends GameLayer {
  ...
  constructor(private behaviour: ClueSolvingBehaviour) {
    super();
    ...
    this.sidebar.content.append(
      new ClueSolvingMapLayer.MainControlBar(behaviour),
...
export namespace ClueSolvingMapLayer {
  import hbox = C.hbox;
