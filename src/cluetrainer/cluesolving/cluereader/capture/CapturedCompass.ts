...
export class CapturedCompass {
  ...
  constructor(public readonly body: CapturedImage,
              public readonly finder: CapturedCompass.CompassFinder,
  ...
  recapture(img: CapturedImage): CapturedCompass {
    return new CapturedCompass(this.body.recapture(img), this.finder, this.calibration_functions)
  }

  withCalibrationFunctions(calibration_functions: (_: AntialiasingType) => CompassCalibrationFunction): CapturedCompass {
    return new CapturedCompass(this.body, this.finder, calibration_functions)
  }
