...
import {Lockboxes} from "../../cluetheory/Lockboxes";
...
export class LockboxSolving extends AbstractPuzzleSolving<ClueReader.Result.Puzzle.Lockbox, LockboxSolvingProcess> {
  ...
  constructor(parent: ClueSolvingBehaviour,
    ...
    super("Lockbox", parent, lockbox, deps().app.settings.settings.solving.puzzles.lockboxes.autostart, "Lockbox Puzzle", "lockboxes");
  }
