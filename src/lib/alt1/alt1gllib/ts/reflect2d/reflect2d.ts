...
import { RenderInvocation, TextureSnapshot } from "../util/alt1gltypes";
...
class AtlasTextureSnapshotCache {
	...
	constructor(snap: TextureSnapshot) {
		this.snapshot = snap;
		this.whitesprite = {
...
export class AtlasTracker {
	cache = new ReffingMap<TextureSnapshot, AtlasTextureSnapshotCache>();
	...
	getSubcache(tex: TextureSnapshot) {
...
export function getUIState(renders: RenderInvocation[], cache: AtlasTracker) {
