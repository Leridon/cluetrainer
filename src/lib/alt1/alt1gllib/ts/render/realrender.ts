...
import { GlProgram, RenderInvocation, TextureSnapshot, TrackedTexture } from "../util/alt1gltypes";
...
export class RealRenderer {
    voas = new Map<RenderInvocation, { voa: WebGLVertexArrayObject, transformed: Float32Array | null }>();
    textures = new Map<TrackedTexture, WebGLTexture>();
    programs = new Map<GlProgram, ProgmetaEntry>();
    ...
    getTexture(sampler: TextureSnapshot) {
