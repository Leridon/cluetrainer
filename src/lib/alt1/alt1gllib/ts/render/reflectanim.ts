...
import { Alt1GlClient, RenderInvocation } from "../util/alt1gltypes";
import { getVertexFlag, returnVertexFlags } from "../util/patchrs_napi";
...
export async function recordAnimdata(api: Alt1GlClient, chr: CharacterRef, duration: number) {
...
export class AnimBuffer {
	...
	addFrame(render: RenderInvocation) {
