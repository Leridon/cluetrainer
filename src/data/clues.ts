...
export namespace clue_data {
  ...
  export const simple: Clues.Simple[] = [
    {
      ...
      "solution": {
        "type": "talkto",
        "spots": [{"range": {"origin": {"x": 3202, "y": 3205, "level": 0}, "size": {"x": 21, "y": 28}}, "description": "at Lumbridge Castle"}],
        "npc": "Hans"
      }
    }, {
      "id": 69,
      ...
      "solution": {"type": "search", "entity": "Drawers", "spot": {"level": 1, "topleft": {"x": 2970, "y": 3214}, "botright": {"x": 2970, "y": 3214}}}
    }, {
      "id": 91,
      "type": "simple",
      "tier": "easy",
  ...
  export const cryptic: Clues.Cryptic[] = [
    ...
    },
    {
      ...
      "solution": {"type": "dig", "spot": {"x": 2656, "y": 3161, "level": 0}, "description": "in front of the door"}
    }, {
      "id": 198,
      "type": "cryptic",
      "tier": "medium",
      ...
      "solution": {"type": "dig", "spot": {"x": 3175, "y": 2915, "level": 0}, "description": "west of the cart"}
    }, {
      "id": 218,
      "type": "cryptic",
      "tier": "medium",
      ...
      "solution": {"type": "dig", "spot": {"x": 2993, "y": 3178, "level": 0}, "description": "west of the church near Port Sarim"}
    }, {
      "id": 28,
      "type": "cryptic",
      "tier": "hard",
      ...
      "solution": {"type": "dig", "spot": {"x": 3161, "y": 9904, "level": 0}, "description": "next to the cauldron"}
    }, {
      "id": 155,
      "type": "cryptic",
      "tier": "hard",
      ...
      "solution": {
        "type": "talkto",
        "spots": [{"range": {"origin": {"x": 3219, "y": 3434, "level": 0}, "size": {"x": 6, "y": 5}}, "description": "near Varrock's fountain"}],
        "npc": "Wilough"
      }
    }, {
      "id": 175,
  ...
  export const emote: Clues.Emote[] = [
    {
      ...
      "area": {"origin": {"x": 3085, "y": 3332, "level": 0}, "size": {"x": 6, "y": 6}},
      ...
      "emotes": ["Salute"],
      "double_agent": true,
      "area": {"origin": {"x": 2908, "y": 3155, "level": 0}, "size": {"x": 27, "y": 20}},
      ...
      "emotes": ["Blow kiss"],
      "double_agent": true,
      "area": {"origin": {"x": 2851, "y": 2952, "level": 0}, "size": {"x": 3, "y": 4}},
      ...
      "area": {"origin": {"x": 4630, "y": 5104, "level": 0}, "size": {"x": 14, "y": 14}},
      ...
      "area": {"origin": {"x": 2391, "y": 3362, "level": 0}, "size": {"x": 26, "y": 22}},
      "emotes": ["Bow or Curtsy"],
      "double_agent": true,
  ...
  export const map: Clues.Map[] = [
    {
      ...
      "solution": {"type": "dig", "description": "three tiles east of the tree", "spot": {"x": 3164, "y": 3359, "level": 0}}
    }, {
      "id": 44,
      "type": "map",
      "tier": "medium",
      ...
      "solution": {"type": "dig", "description": "west of the Chemist's House", "spot": {"x": 2924, "y": 3208, "level": 0}}
    }, {
      "id": 52,
      "type": "map",
      "tier": "medium",
      ...
      "solution": {"type": "dig", "description": "south of the giant head", "spot": {"x": 2650, "y": 3231, "level": 0}}
    }, {
      "id": 57,
      "type": "map",
      "tier": "medium",
      ...
      "solution": {"type": "dig", "spot": {"x": 2906, "y": 3294, "level": 0}, "description": "west of the snape grass at the tip of the hobgoblin peninsula."}
    }, {
      "id": 60,
      "type": "map",
      "tier": "medium",
      ...
      "solution": {"type": "dig", "spot": {"x": 2578, "y": 3597, "level": 0}, "description": "at the end of the branching path next to the crystal tree"}
    }, {
      "id": 61,
      "type": "map",
  ...
  export const anagram: Clues.Anagram[] = [
    {
      ...
      "challenge": [{
        ...
        "question": "How many camels live in the zoo?",
        "answers": [{"answer": 3}]
      }],
      "solution": {
        "type": "talkto",
      ...
      "solution": {
        "type": "talkto",
        "spots": [{"range": {"origin": {"x": 2869, "y": 9877, "level": 0}}, "description": "in the Dwarven Tunnel under the White Wolf Mountain"}],
        "npc": "Captain Ninto"
      },
      ...
      "solution": {
        "type": "talkto",
        "spots": [{"range": {"origin": {"x": 2384, "y": 4466, "level": 0}, "size": {"x": 7, "y": 6}}, "description": "north of the bank in Zanaris"}],
        "npc": "Fairy Nuff"
      },
      "anagram": ["I Faffy Run"]
    }, {
      ...
      "solution": {
        ...
        "spots": [{
          ...
          "range": {"origin": {"x": 3256, "y": 3355, "level": 0}},
  ...
  export const scan: Clues.Scan[] = [
    {
      ...
      "spots": [
        ...
        {"x": 1426, "y": 5718, "level": 0},
        {"x": 1417, "y": 5684, "level": 0},
        {"x": 1405, "y": 5651, "level": 0},
        {"x": 1392, "y": 5730, "level": 0},
        {"x": 1349, "y": 5716, "level": 0},
        {"x": 1361, "y": 5733, "level": 0},
        {"x": 1307, "y": 5622, "level": 0},
        {"x": 1375, "y": 5687, "level": 0},
        {"x": 1332, "y": 5651, "level": 0},
        {"x": 1373, "y": 5634, "level": 0},
        {"x": 1351, "y": 5659, "level": 0},
        {"x": 1368, "y": 5609, "level": 0},
